...
public class testLinkedList {
	...
	/*
	 * 	If LinkedList contains no nodes 
	 *  then getLast() should return null
	 * */
	@Test
	...
	/*
	 * 	If LinkedList contains 1 node
	 *  then getLast should return that exact node
	 * */
	...
	/*
	 * test that if a LinkedList contains no nodes
	...
	/*
	 * 	Add 2 Nodes to LinkedList.
	 *  Check that size of LinkedList is 2
	 * */
	@SuppressWarnings("unchecked")
	@Test
	...
	/*
	 * 	If a LinkedList contains 1 value
	 *  then the index of that value in the LinkedList should be 0
	 * */
	@Test
	...
	/*
	 * 	If we add the same string twice to a Linkedlist, and remove the string once
	 *  then only the first occurrence of the LinkedList should be removed.
	 * */
	@Test
	...
	/*
	 * If the first element of a LinkedList is removed
	 * then the element after the first element should now be the first element
	 * */
	@Test
	...
	//////////////////////////////////////////////////////////////////////////
	/*
	 * 	If you call addLast on an empty list
	 *  then addlast should append the new object as root of that list
	 * */
	@Test
